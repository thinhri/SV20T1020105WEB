...
namespace SV20T1020105.Web.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(int id = 0)
        {
            ...
            ViewBag.HideAccept = true;
			ViewBag.HideDelete = true;
			ViewBag.HideShip = false;
			ViewBag.HideFinish = false;
			...
			{
				ViewBag.HideAccept = false;
				ViewBag.HideShip = true;
				ViewBag.HideFinish = false;
			}
        ...
        /// <returns></returns>
        [HttpPost]
        public IActionResult Shipping(int OrderID = 0, int shipperID = 0)
        {
            if (shipperID <= 0)
        ...
        public IActionResult ProvinceAndAddress(int OrderID = 0)
        {
        ...
        public IActionResult Update(int OrderID, string DeliveryAddress, string DeliveryProvince)
        {
            ...
            bool result = OrderDataService.UpdateOrder(OrderID, DeliveryAddress, DeliveryProvince);
            if (!result)
                return Json("Khong the cap nhat don hang");
            return Json("");
        }
        /// <summary>
        ...
        [HttpPost]
        public IActionResult AddToCart(int ProductID = 0, string ProductName="", string Photo="", 
                                    string Unit="", decimal SalePrice = 0, int Quantity = 0 )
        {
