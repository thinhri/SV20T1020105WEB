...
namespace SV20T1020105.BusinessLayers
{
    public static class OrderDataService
    {
        ...
        /// <summary>
        /// Cập nhật tỉnh thành/ Địa chỉ đơn hàng
        /// </summary>
        /// <param name="orderID"></param>
        /// <param name="CustomerID"></param>
        /// <returns></returns>
        public static bool UpdateOrder(int orderID, string deliveryAddress, string deliveryProvince)
        {
            Order? data = orderDB.Get(orderID);
            if (data == null)
                return false;
        ...
        {
            return orderDB.ListStatus().ToList();
        }
    }
}
